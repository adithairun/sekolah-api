...
if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && ( $_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest' )) {
	...
	$result = $mysqli->query("SELECT RIGHT(id_siswa,4) as kode FROM data_siswa ORDER BY id_siswa DESC LIMIT 1")
	                          or die('Ada kesalahan pada query tampil data id_siswa: '.$mysqli->error);
