...
<head>
  ...
  <title>LOGIN <?php echo $apk_name ?></title>
...
<div class="login-box">
  ...
  <div class="card">
	...
	<div class="panel-heading">
			...
			<center><h4 class="panel-title">ADMIN <?php echo $apk_name ?></h4></center><?php if(isset($_GET['pesan'])){	if($_GET['pesan'] == "gagal"){		echo "Login gagal! username dan password salah!";	}else if($_GET['pesan'] == "logout"){		echo "Anda telah berhasil logout";	}else if($_GET['pesan'] == "belum_login"){		echo "Anda harus login untuk mengakses halaman admin";	}}?>
...
<form method="post" action="login_query.php">
  <!--    <form action="login_query" autocomplete="off"  method="POST"> -->
	  ...
	  <center class="nav-link text-black text-center" ><i class="far fa-copyright"></i>
            <strong> <a href="https://github.com/adithairun/sistem-ekskul" target="_blank"> 2021 <?php echo $apk_name ?></strong> <i>Versi <?php echo $versi?></i></a></center>
