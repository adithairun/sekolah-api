    ...
    <body>
        <div class="container-fluid">
            <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
                <h5 class="my-0 mr-md-auto font-weight-normal"><i class="fas fa-users title-icon"></i> Data Siswa</h5>
                ...
                <a class="btn btn-info"  href="../home"><i class="fas fa-plus"></i> Home</a>
        ...
        <div class="modal fade" id="modalUbah" tabindex="-1" role="dialog" aria-labelledby="modalUbah" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-edit"></i> Ubah Data Siswa</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    ...
                    <form id="formUbah">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" id="id_siswa" name="id_siswa" autocomplete="off" readonly>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nama_siswa_ubah" name="nama_siswa" autocomplete="off">
                            </div>
							
							<div class="form-group">
                                <label>NIS</label>
                                <input type="text" class="form-control" id="nis_ubah" name="nis" autocomplete="off">
                            </div>
							<div class="form-group">
                                <label>JK</label>
                                <input type="text" class="form-control" id="jk_ubah" name="jk" autocomplete="off">
                            </div>
							<div class="form-group">
                                <label>NISN</label>
                                <input type="text" class="form-control" id="nisn_ubah" name="nisn" autocomplete="off">
                            </div>
							<div class="form-group">
                                <label>Tempat Lahir</label>
                                <input type="text" class="form-control" id="tempat_lahir_ubah" name="tempat_lahir" autocomplete="off">
                            </div>
        ...
        $(document).ready(function(){
            ...
            var table = $('#tabel-transaksi').DataTable( {
                ...
                "columnDefs": [ 
                    ...
                    { "targets": 6, "width": 'auto', "className": 'right' },
                ...
                "iDisplayLength": 5,               // tampilkan 5 data
                ...
                $.ajax({
                   ...
                   data : {id_siswa:id_siswa},
                    ...
                    success: function(result){
                        ...
                        $('#nama_siswa_ubah').val(result.nama_siswa);
                        $('#nis_ubah').val(result.nis);
                        $('#jk_ubah').val(result.jk);
                        $('#nisn_ubah').val(result.nisn);
                        $('#tempat_lahir_ubah').val(result.tempat_lahir);
