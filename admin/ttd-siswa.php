	 	          ...
	 	          <li class="nav-item has-treeview ">
	 	            ...
	 	            <ul class="nav nav-treeview">
	 						...
	 						<li class="nav-item has-treeview  menu-open">
	 							<a href="ttd-siswa" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Data TTD Siswa</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="home.php">Home</a></li>
              <li class="breadcrumb-item active">Data TTD Siswa</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<!-- DATA TABLE UNTUK TES -->
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Daftar TTD</h3>
          ...
          <th>No</th>
				...
				$no=1;
					$query = mysqli_query($conn, "select * from signature NATURAL JOIN student NATURAL JOIN ekskul") or die(mysqli_error());
     ...
     ?>
					...
					<!--			<input type="hidden" name="image" value="<?php echo $fetch['base64']?>"/>
							<input type="hidden" name="filename" value="<?php echo $fetch['img']?>"/>
								<br>
								<a target=”_blank” href="data:<?php echo $fetch['base64']?> "   class="btn btn-sm btn-success" ><span class="ion-archive"></span> Tampilkan</a>
<!--
								 | -->
								 														<a href="backend/hapus_ttd?id=<?php echo $fetch['id'];?>"
								 															onclick="return confirm('Tanda Tangan Akan Dihapus, Lanjutkan ?')"><button
								 																class="btn btn-warning"> <span
								 																	class="ion-trash-a"></span> Hapus TTD</button></a> 
</td>
						 <td><?php echo $fetch['nama_siswa']?></td>
						 <td><?php echo $fetch['nama_ekskul']?></td>
						 <td><img width="200px" src="data:<?php echo $fetch['base64']?> "></td>
