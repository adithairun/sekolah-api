               ...
               with font-awesome or any other icon font library -->
						...
						<li class="nav-item has-treeview menu-open">
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item">
									<a href="anggota-ekskul" class="nav-link active">
										<i class="far fa-circle nav-icon"></i>
		...
		<div class="content-wrapper">
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Data Anggota Ekstrakurikuler</li>
							</ol>
						</div>
					</div>
				</div><!-- /.container-fluid -->
			...
			<section class="content">
						...
						<div class="card">
							...
							<div class="card">
								<div class="card-header">
									...
									<form method="post" enctype="multipart/form-data" action="backend/upload_anggota">
										<br>
										Pilih File: <br>
										...
										<a style="color:black">*Download Template file excel <a
												href="file/template-anggota.xls">Download</a><br><br>
								...
								<div class="card-body">
									<!--	<a href="backend/reset_anggota"
										onclick="return confirm('Seluruh Pengguna Akan Dihapus, File yang diupload tetap ada. Lanjutkan ?')"><button
											class="btn btn-danger"> <span class="ion-aperture"></span> Format Data
											Anggota</button></a> -->
									...
									<button class="btn btn-success" data-toggle="modal" data-target="#form_modal"><span>
											<span class="fas fa-plus-circle"></span> Tambah Anggota</button>
				...
				$no=1;
					...
					$query = mysqli_query($conn, "SELECT * FROM student NATURAL JOIN ekskul") or die(mysqli_error());
				...
				?>
											...
											<tr class="del_student<?php echo $fetch['stud_id']?>">
												...
												<td>
													<center>
														...
														<button class="btn btn-success" data-toggle="modal"
															data-target="#edit_modal<?php echo $fetch['stud_id']?>"><span
																class="ion-compose"></span> Edit</button>

														<a href="backend/hapus_anggota.php?stud_id=<?php echo $fetch['stud_id'];?>"
															onclick="return confirm('Pengguna Akan Dihapus, Lanjutkan ?')"><button
																class="btn btn-warning"> <span
																	class="ion-trash-a"></span> Hapus
																Anggota</button></a>
												...
												<td><?php echo $fetch['username_siswa']?></td>
												<td><?php echo $fetch['password_siswa']?></td>

												<td><?php echo $fetch['nama_ekskul']?></td>
												<td>
																				<?php
														if ($fetch['foto_siswa']!=''){
														  echo "<img src=\"../gambar/siswa/$fetch[stud_id]/$fetch[foto_siswa]\" height=100 />";
														}
														else{
														  echo "<img src=\"../gambar/siswa/no-foto.jpg\" height=100>";
														} ?>
...
?>
												...
												<div class="modal fade" id="edit_modal<?php echo $fetch['stud_id']?>"
													aria-hidden="true">
													...
													<div class="modal-dialog modal-dialog-centered">
														...
														<div class="modal-content">
															...
															<form method="POST" action="backend/update_anggota.php">
																	...
																	<div class="col-md-6">
																		...
																		<div class="form-group">
																			...
																			<input type="text" name="nama_siswa"
																				class="form-control"
																				value="<?php echo $fetch['nama_siswa']?>"
																				required="required" />
																		...
																		<div class="form-group">
																			...
																			<input type="text" id="username_siswa1"
																				name="username_siswa"
																				class="form-control"
																				value="<?php echo $fetch['username_siswa']?>"
																				required="required" />
																			<!--				<div id="result1"></div> -->
																		...
																		<div class="form-group">
																			...
																			<input type="text" name="password_siswa"
																				class="form-control"
																				value="<?php echo $fetch['password_siswa']?>"
																				required="required" />
																		...
																		<div class="form-group">
																			...
																			<select name="ekskul_id"
																				class="form-control"
																				required="required">
																				<option hidden>Pilih Ekskul</option>
																				<?php
									...
									while($data = mysqli_fetch_assoc($result) ){?>
												...
												<script type="text/javascript">
													$(document).ready(function () {
														$('#username_siswa1').keyup(function () {
															var uname = $('#username_siswa1').val();
															if (uname == 0) {
																$('#result1').text('');
															} else {
																$.ajax({
																	url: 'backend/cek_anggota1.php',
																	type: 'POST',
																	data: 'username_siswa1=' + uname,
				...
				?>
								...
								<script type="text/javascript">
									$(document).ready(function () {
										$('#username_siswa').keyup(function () {
											var uname = $('#username_siswa').val();
											if (uname == 0) {
												$('#result').text('');
											} else {
												$.ajax({
													url: 'backend/cek_anggota.php',
													type: 'POST',
													data: 'username_siswa=' + uname,
													success: function (hasil) {
														if (hasil > 0) {
								...
								<div class="modal fade" id="exampleModal<?php echo $fetch['stud_id']?>" tabindex="-1"
									...
									$no=1;
										...
										$query = mysqli_query($conn, "SELECT * FROM ekskul ORDER BY nama_ekskul") or die(mysqli_error());
	...
	?>
		<div class="modal fade" id="form_modal" aria-hidden="true">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<form method="POST" action="backend/save_anggota.php">
						<div class="modal-header">
							<h4 class="modal-title">Tambah Anggota Ekskul</h4>
						</div>
						<div class="modal-body">
							<div class="col-md-3"></div>
							<div class="col-md-6">
	...
	while($data = mysqli_fetch_assoc($result) ){?>
								...
								<div class="form-group">
									<label>Username</label>
									<input type="text" id="username_siswa"
										name="username_siswa"
										class="form-control"
										required="required" />
									<div id="result"></div>
								...
								<input type="hidden" name="foto_siswa"
								value=""
									required="required" />
							</div>
						</div>
