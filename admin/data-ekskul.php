							...
							<div class="card">
								...
								<div class="card-body">
									...
									<button class="btn btn-success" data-toggle="modal" data-target="#form_modal"><span
											class="fas fa-plus-circle"></span> Tambah Ekstrakurikuler</button>
														...
														<a href="backend/hapus_ekskul?ekskul_id=<?php echo $fetch['ekskul_id'];?>"
															onclick="return confirm('Pengguna Akan Dihapus, Lanjutkan ?')"><button
																class="btn btn-warning"> <span
																	class="ion-trash-a"></span> Hapus Ekskul</button></a>
							...
							if(uname == 0) {
								...
								$.ajax({
									...
									success: function(hasil) {
										if(hasil > 0) {
											$('#result1').text('Ekstrakurikuler Tidak Bisa diubah, atau sama dengan ekskul yang sudah ada');
										}
										else {
											$('#result1').text('Ekstrakurikuler Bisa Ditambah');
										}
									}
								});
							}
