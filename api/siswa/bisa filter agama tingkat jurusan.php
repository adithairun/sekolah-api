...
$agama_name = '';
if (!empty($agama)) {
    $agama_name = ' where agama LIKE \'%'.$agama.'%\' and tingkat LIKE \'%'.$tingkat.'%\' and jurusan LIKE \'%'.$jurusan.'%\'and jk LIKE \'%'.$jk.'%\' ';
}
...
$cat_list = $db->query('select * from data_siswa  '.$agama_name.'' .$tingkat_name.''.$jurusan_name.''.$jk_name.''.$sql_limit);
$arr = array();
$arr['info'] = 'success';
